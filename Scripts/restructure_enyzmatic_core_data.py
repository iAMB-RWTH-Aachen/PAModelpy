...
data_path = 'Data/proteinAllocationModel_iML1515_EnzymaticData_py_uniprot.xlsx'
enzyme_db = pd.read_excel(data_path, sheet_name='ActiveEnzymes')
...
print(new_enzyme_db[new_enzyme_db['rxn_id'] == 'TSULabcpp'])